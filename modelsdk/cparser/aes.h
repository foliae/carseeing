...
// Error information
#define ERR_AES_NO_ERROR 0x0000
#define ERR_AES_INVALID_INPUT_LENGTH 0x0001
#define ERR_AES_INVALID_KEY_LENGTH 0x0002
#define ERR_AES_OUTPUT_BUFF_EMPTY 0x0003
